<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\wamp\www\slsh\public/../application/index\view\index\list.html";i:1481800267;}*/ ?>
	<!DOCTYPE html>
	...
	<head>
		...
		<link href="__STATIC__/Reception/Css/channel.css" rel="stylesheet" type="text/css">
				...
				<div class="content typepage typepage-pad">
					...
					<div class="select clearfix">
						<div class="oc clearfix pull-left f-li ">
							...
							<div class="f-select pull-left clearfix">
								<div class="pull-left leftpart">
									<a href="/prolist/index/40/0-0-0-0-0-0-0" class="active">
										<span class="f-all line">全部</span>
									</a>
								</div>

								<div class="pull-left rightpart">
									<?php foreach($smallplate as $small): if($small['slsh_bigid'] == $plateid): ?>
									<a href="" class="">
										<span class="line"><?php echo $small['slsh_class']; ?></span>
									</a>
						...
						<div class="oc clearfix pull-left f-li f-pai">
							...
							<div class="f-select pull-left clearfix">
								<div class="pull-left leftpart">
									<a href="/prolist/index/40/140-0-0-0-0-0-0" class="active">
										<span class="f-all line">默认</span>
									</a>
								</div>
								<div class="pull-left rightpart">
									<a href="/prolist/index/40/140-0-0-0-0-0-2" class="">
										<span class="line">价格从低到高</span>
									</a>
									<a href="/prolist/index/40/140-0-0-0-0-0-3" class="">
					...
					<div class="f-list clearfix">
						<div class="leftpart pull-left">
							<ul>
								<?php if($plateid == 5): foreach($dis as $goodinfo2): ?>
								<li>
									<div class="wrap">
										<div class="s-img">
											<a href="__SITE__/index/good/goodinfo/goodid/<?php echo $goodinfo2['slsh_goodid']; ?>" data-url='/prodetail/index/14313' target="_blank">
												<img class="lazy" data-original="__SITE__<?php echo $goodinfo2['slsh_picture']; ?>"
												src="__STATIC__/Reception/Picture/default.png" alt=""/>
											</a>
										</div>
										<div class="s-info clearfix">
											<?php echo $goodinfo2['slsh_goodname']; ?>
											<div style="position: absolute;height:10px;width:30px;background:;margin-left:175px;margin-top: -25px;opacity: 0.5;color:red; ">——</div>
											<span class="s-unit pull-right font-color" style="color:green;">￥<?php echo $goodinfo2['slsh_discount']; ?></span>
											<span class="s-unit pull-right font-color" >￥<?php echo $goodinfo2['slsh_goodprice']; ?></span>
										</div>
										<div class="p-operate clearfix">
											<div class="s-kg clearfix pull-left">
												<span data-price="29.90" data-ppid="17339" data-pno="2161107110" class="kg02 cur pull-left">
													<?php echo $goodinfo2['slsh_spec']; ?>
												</span>
												
											</div>
											<div class="s-che pull-right" pid="14313" ppid="17339" type="normal" pno="2161107110">

											</div>
										</div>
									</div>
								</li>
								<?php endforeach; else: foreach($smallplate as $small): if($small['slsh_bigid'] == $plateid): if($small['slsh_bigid'] == 3): foreach($good1 as $goodinfo1): if($goodinfo1['slsh_category'] == $small['slsh_plateid']): ?>
								<li>
									<div class="wrap">
										<div class="s-img">
											<a href="__SITE__/index/good/nutinfo/itemid/<?php echo $goodinfo1['slsh_goodid']; ?>" data-url='/prodetail/index/14313' target="_blank">
												<img class="lazy" data-original="__SITE__<?php echo $goodinfo1['slsh_picture']; ?>"
												src="__STATIC__/Reception/Picture/default.png" alt=""/>
											</a>
										</div>
										<div class="s-info clearfix">
											<span class="s-unit pull-right font-color">￥<?php echo $goodinfo1['slsh_goodprice']; ?></span>
											<?php echo $goodinfo1['slsh_goodname']; ?>
										</div>
										<div class="p-operate clearfix">
											<div class="s-kg clearfix pull-left">
												<span data-price="29.90" data-ppid="17339" data-pno="2161107110" class="kg02 cur pull-left">
													<?php echo $goodinfo1['slsh_spec']; ?>
												</span>
								...
								<?php endif; endforeach; else: foreach($good as $goodinfo): if($goodinfo['slsh_category'] == $small['slsh_plateid']): ?>
								<li>
									<div class="wrap">
										<div class="s-img">
											<a href="__SITE__/index/good/goodinfo/goodid/<?php echo $goodinfo['slsh_goodid']; ?>" data-url='/prodetail/index/14313' target="_blank">
												<img class="lazy" data-original="__SITE__<?php echo $goodinfo['slsh_picture']; ?>"
												src="__STATIC__/Reception/Picture/default.png" alt=""/>
											</a>
										</div>
										<div class="s-info clearfix">
											<span class="s-unit pull-right font-color">￥<?php echo $goodinfo['slsh_goodprice']; ?></span>
											<?php echo $goodinfo['slsh_goodname']; ?>
										</div>
										<div class="p-operate clearfix">
											<div class="s-kg clearfix pull-left">
												<span data-price="29.90" data-ppid="17339" data-pno="2161107110" class="kg02 cur pull-left">
													<?php echo $goodinfo['slsh_spec']; ?>
												</span>
								...
								<?php endif; endforeach; endif; endif; endforeach; endif; ?>
								<script>
