<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wamp64\www\slsh\public/../application/index\view\good\goodinfo.html";i:1481791601;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <link href="__STATIC__/Reception/Css/detail.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="__STATIC__/Reception/Scripts/myfocus.js"></script>
    <script type="text/javascript" src="__STATIC__/Reception/Scripts/add.js"></script>
    <script type="text/javascript" src="__STATIC__/Reception/Scripts/tabs.js"></script>
    <!--[if lt IE 9]>
        ...
        <div class="topnav">
            <div class="content clearfix">
                <span class="pull-left">
                  <span class="pull-left p-common-region" id="region"> <img src="__STATIC__/Reception/Images/car.jpg">
                    ...
                    <div class="p-common-regionCon hide" id="regSel">
                        ...
                        <ul class="list-unstyled regionsel">
                            ...
                            <li>
                                <a href="javascript:;" data-id="145855">上海崇明</a>
                            </li>
                            <li>
    ...
    <li class="p-common-topsubnav">
        ...
        <div class="p-common-noticelist hide">
            <ul class="list-unstyled">
                ...
                <li>|</li>
                <li class="p-common-topsubnav">
                    <img src="__STATIC__/Reception/Images/phone.jpg" /> 手机生活
                    <div class="p-common-topcode hide">
                        <div class="text-center">
                            <span class="VI-color2">下载生活app，</span> 即享特价生活商品
                        </div>
                        <dl class="clearfix">
                            <dt>
                        ...
                        <dl class="clearfix">
                            ...
                            <dd>
                                <span class="VI-color2">关注生活微信</span> 优惠信息实时掌握
                            </dd>
                        </dl>
                    </div>
                </li>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav" id="navcon">
                     <?php foreach($bigplate as $val): if($val['slsh_plateid'] == 1): ?>
                     <li class="">
                        <a href="__SITE__">
                            <?php echo $val['slsh_class']; ?>
                            <span><?php echo $val['slsh_english']; ?></span>
                        </a> <em></em>
                    </li>
                    <?php else: ?>
                    <li class="">
                        <a href="__SITE__/index/index/list/plateid/<?php echo $val['slsh_plateid']; ?>">
                            <?php echo $val['slsh_class']; ?>
                            <span><?php echo $val['slsh_english']; ?></span>
                        </a> <em></em>
                    </li>
                    ...
                    <li class="">
                        <a href="__SITE__/index/index/list/plateid/5">
                            折扣专区
                            <span>Discount</span>
                        </a> <em></em>
                    </li>
...
<!-- 水果信息开始 -->
<?php foreach($goodinfo as $info): ?>
<div class="content typepage clearfix">
    <div class="bread">
        <strong class="lvse"><a href="/">首页</a></strong>
        <span class="lvse">
            &gt;
            <a href="/prolist/index/40">新鲜水果</a>
            &gt;
        </span>
        <span class="huise "  ><?php echo $info['slsh_goodname']; ?></span>
    </div>
    ...
    <div id="MyFocus" class="pull-left">
        <ul class="dianul">
            <li class=" cur">
                <img src="__SITE__<?php echo $info['slsh_picture']; ?>"  id="src1111"/>

            </li>
            <li class=" ">
                <img src="__SITE__<?php echo $info['slsh_picture1']; ?>" />
                
            </li>
            <li class=" ">
                <img src="__SITE__<?php echo $info['slsh_picture2']; ?>" />
                
            </li>
            <li class="last ">
                <img src="__SITE__<?php echo $info['slsh_picture3']; ?>" />
        ...
        <ul class="tuul">
            <li class="cur">
                <a href="javascript:;">
                    <img src="__SITE__<?php echo $info['slsh_picture']; ?>" />
                </a>
            </li>
            <li class="cur">
                <a href="javascript:;">
    ...
    <div class="product-info pull-left">
        <div class="country clearfix">
            <div class="name pull-left">
                <h3 class="goodname"><?php echo $info['slsh_goodname']; ?></h3>
        ...
        <div class="price-info">
            <div class="price01 clearfix">
                <div class="box pull-left">
                    <h5 class="pull-left">生活价</h5>
                    <span class="pull-left price-sp money" id="jq-price">￥<?php echo $info['slsh_goodprice']; ?></span>
                </div>
                <div class="box2 pull-right">
                    <div class="weixin">
                        <img src="/Picture/api.php" />
                    </div>
                </div>
            ...
            <div class="guige clearfix">
                ...
                <div class="zhuang pull-left">
                    <span data-old-price="39.90" data-price="39.90" data-pid="14340" data-ppid="17373" data-product_no="2151119101" data-outofstock="0" class="pull-left current spec"><?php echo $info['slsh_spec']; ?></span>
                </div>
            ...
            <div class="number clearfix">
                ...
                <div class="goods-buy01 pull-left clearfix">
                    ...
                    <input class="pull-left add111" id="add" type="tel" value="1">
            ...
            <div class="buy clearfix">
                ...
                <div class="fr-buy pull-left">
                    <a href="__SITE__/index/good/order/oider/<?php echo $info['slsh_goodid']; ?>" class="btn btn-primary btn-lg active " role="button" title="点击此按钮，到下一步确认购买信息">立即购买</a>
                </div>

                <div class="fr-add pull-left">
                    <a href="javascript:;" class="btn btn-primary btn-lg active " title="加入购物车" role="button" id="buy">
                        加入购物车
                    </a>
                </div>
                <input type="hidden" name="goodid"  value="<?php echo $info['slsh_goodid']; ?>" id="id1">
            </div>
        </div>
        ...
        <div class="comment clearfix">
                ...
                <!--<div class="pull-left clearfix">
                    ...
                    <span class="pull-left">芒果</span>
                </div>-->
                <div class="pull-left clearfix">
                    <h5 class="pull-left">产地</h5>
                    <span class="pull-left"><?php echo $info['slsh_orign']; ?></span>
                </div>
                <div class="pull-left clearfix">
                ...
                <div class="pull-left clearfix">
                    ...
                    <span class="pull-left" id="product_no">2151119101</span>
                </div>
            </div>
        </div>
        <!-- 产品信息结束 -->
        ...
        <!--  评论开始-->
        <input type="hidden" id="product_id" value="14340">
        ...
        <div class="assess clearfix">
            <div class="leftpart pull-left">
                <div class="good-details js_fixed clearfix" id="js_fixed">
                    ...
                    <span class="pull-left">
                        顾客评论 <b id="comment_total_top">(<?php echo $num; ?>)</b>
                    </span>
                ...
                <div class="good-comments">
                            ...
                            <body>
                                <div class="app-detail">
                                    <style type="text/css">
                                        ...
                                        .dynamic-prop-table dl:nth-child(odd) {
                                            background: #f7f7f7
                                        }

                                        .dynamic-prop-table dl:last-of-type {
                                            border-bottom: 0
                                        }

                                        .dynamic-prop-table dl dt {
                                            width: 86px;
                                            text-align: left;
                                            padding: 9px 12px
                                        }
                                    ...
                                    <img class="lazy" src="__SITE__<?php echo $info['slsh_photo']; ?>" data-original="https://imgqn9.fruitday.com/up_images/20161117/14793458126020.gif" _data-original="https://imgqn9.fruitday.com/up_images/20161117/14793458126020.gif" /><img class="lazy" src="__SITE__<?php echo $info['slsh_photo1']; ?>" data-original="https://imgqn9.fruitday.com/up_images/20161117/14793458141414.gif" _data-original="https://imgqn9.fruitday.com/up_images/20161117/14793458141414.gif" />
                                    <?php if($info['slsh_photo2'] == '/static/Reception/Picture/default.png'): else: ?>
                                    <img class="lazy" src="__SITE__<?php echo $info['slsh_photo2']; ?>" data-original="https://imgqn9.fruitday.com/up_images/20161117/14793458154150.gif" _data-original="https://imgqn9.fruitday.com/up_images/20161117/14793458154150.gif" />
                                    <?php endif; if($info['slsh_photo3'] == '/static/Reception/Picture/default.png'): else: ?>
                                    <img class="lazy" src="__SITE__<?php echo $info['slsh_photo3']; ?>" data-original="https://imgqn9.fruitday.com/up_images/20161117/14793458171235.gif" _data-original="https://imgqn9.fruitday.com/up_images/20161117/14793458171235.gif" />
                                    <?php endif; ?>
                                </div>
                            </body>
                    ...
                    <ul class="no2" style="display: none;">
                        ...
                        <div class="detail-user">
                            ...
                            <div class="detail-user-title  clearfix">
                                <ul>
                                    <li val="" id="c_all_another" class="now-gray pull-left">
                                        ...
                                        全部评论(
                                        <span id="comment_total"><?php echo $num; ?></span> )
                                    </li>
                            ...
                            <?php if(!empty($v['slsh_picture'])): ?>
                                <div class="nocomm"><img src="__SITE__<?php echo $v['slsh_picture']; ?>" alt=" "><?php echo $v['slsh_content']; ?></div>

                            <?php else: ?>
                                <div class="nocomm"><?php echo $v['slsh_content']; ?></div>
                            <?php endif; ?>
                            </div>
        ...
        <!--
        <div class="product-info number pull-left">
            <div class="comment clearfix">
                <div class="pull-left clearfix">
    ...
    <div class="shop-cart">
        <div class="shop-top">
            <div class="cha pull-right">
                <img src="/Picture/cha.png" alt=""></div>
            </div>
            <div class="shop-content">
                ...
                <p class="row2">
                    购物车中共
                    <em class="cartcount">0</em> 件商品 | 商品小计
            ...
            <section class="toolbarfoot" id="tooft">
                ...
                <a href="#" class="kf">
                    <iframe id="kf" src="/kefu" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" width="35" height="35" style="outline: none;border: 0 none;position: fixed;bottom:39px;">
                    </iframe>
                </a>
            ...
            <script src="/Scripts/require.js" data-main="http://www.fruitday.com/js/main"></script>
            ...
            <div style="margin-left:70px;margin-top:20px; font-size:25px;" id ="cg"></div>
            <span style="float:;margin-left:-80px;margin-top:100px;font-size:20px ;"><a href="" id="guang">继续逛逛</a></span>
            <span id="sec" style="float:left;margin-left:100px;margin-top:80px;font-size:15px;">计算机世</span>
            <span style="float:left;margin-top:80px;font-size:15px ;"><a href="" id="reg">购物车</a></span>
        ...
        <script>
            $(function(){
                var id =$('#id1').val();
                var name=$('.goodname').html();
                var price=$('.money').html();
                var spec= $('.spec').html();
                var src=$('#src1111')[0].src;
                var num = $('.add111').val();
                
                $('#buy').click(function(){
                    $.ajax({
                       type: "POST",
                       url: "http://www.slshengxian.cn/index/good/shopcar1",
                       data: {'goodid':id,'goodname':name,'goodprice':price,'goodspec':spec,'goodsrc':src,'goodnum':num},
                ...
                function jump(count) {    
                    window.setTimeout(function(){    
                        ...
                        if(count > 0) {
                           $('#sec').html(count+' 后跳转');
                           $('#reg').attr("href","__SITE__/index/good/shopcar")
                           $('#reg').innerHTML='购物车';
                           $('#regcg').attr("src","__STATIC__/Reception/Picture/smile.jpg")
                           $("#cg").html('加入购物车成功');
                           $('.loading').css({"display":"block"});
                           $('.back').css({"display":"block"});
                           $('#guang').attr("href","__SITE__/index/index/list/plateid/2") 
                           $('back').css({'display':'block'})
                           jump(count);    
                       } else {    
                        location.href= '__SITE__/index/good/shopcar';
                    }    
                }, 1000);    
                }    
