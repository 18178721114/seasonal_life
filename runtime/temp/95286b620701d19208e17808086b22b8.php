<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp64\www\slsh\public/../application/index\view\index\index.html";i:1481719215;}*/ ?>
﻿<!DOCTYPE html>
...
<section class="p-component-banner" id="p-banner">
    <div class="frame" id="frameBanner">
        <ul class="slidee">
            <li>
                <a href="http://huodong.fruitday.com/cms/indexpc/1201?region_id=106092" style="background-image:url(__STATIC__/Reception/Images/first1.jpg)" target="_blank"></a>
                <!--<a href="http://huodong.fruitday.com/cms/indexpc/1201?region_id=106092" class="lazy" data-original="http://imgws4.fruitday.com/images/2016-11-24/b86ed5a0a251d7facaf42ab5f129c94f.jpg" target="_blank"></a>-->
            </li>
            <li>
                <a href="http://huodong.fruitday.com/cms/indexpc/1451?region_id=106092" style="background-image:url(__STATIC__/Reception/Images/first2.jpg)" target="_blank"></a>
                <!--<a href="http://huodong.fruitday.com/cms/indexpc/1451?region_id=106092" class="lazy" data-original="http://imgws4.fruitday.com/images/2016-11-25/25c9a05863be56d187ec576ac5c14855.jpg" target="_blank"></a>-->
            </li>
            <li>
                <a href="http://huodong.fruitday.com/cms/indexpc/1473?region_id=106092" style="background-image:url(__STATIC__/Reception/Images/first3.jpg)" target="_blank"></a>
                <!--<a href="http://huodong.fruitday.com/cms/indexpc/1473?region_id=106092" class="lazy" data-original="http://imgws4.fruitday.com/images/2016-11-25/1bc416e535ead022dfad769a59d1c944.jpg" target="_blank"></a>-->
            </li>
            <li>
                <a href="http://huodong.fruitday.com/cms/indexpc/1365?region_id=106092" style="background-image:url(__STATIC__/Reception/Images/first4.jpg)" target="_blank"></a>
                <!--<a href="http://huodong.fruitday.com/cms/indexpc/1365?region_id=106092" class="lazy" data-original="http://imgws4.fruitday.com/images/2016-11-03/421b93d8e8e40ec168eb3901c046d329.jpg" target="_blank"></a>-->
            </li>
            <li>
                <a href="http://huodong.fruitday.com/cms/indexpc/1440?region_id=106092" style="background-image:url(__STATIC__/Reception/Images/first5.jpg)" target="_blank"></a>
                <!--<a href="http://huodong.fruitday.com/cms/indexpc/1440?region_id=106092" class="lazy" data-original="http://imgws4.fruitday.com/images/2016-11-17/9198692630a222953e04ee7971480565.jpg" target="_blank"></a>-->
            </li>
            <li>
                <a href="http://huodong.fruitday.com/cms/indexpc/1259?region_id=106092" style="background-image:url(__STATIC__/Reception/Images/first6.jpg)" target="_blank"></a>
                <!--<a href="http://huodong.fruitday.com/cms/indexpc/1259?region_id=106092" class="lazy" data-original="http://imgws4.fruitday.com/images/2016-09-23/ed6ce03521f7b4eaa481cf455afccaf0.jpg" target="_blank"></a>-->
            </li>
        </ul>
    </div>
...
<div class="fruit-kinds ">
    <div class="til clearfix">
        ...
        <div class="textPic"><img class="lazy"  src="__STATIC__/Reception/Picture/Image 1.png"></div>
    </div>
    <div class="good-list clearfix">
        <ul class="clearfix">


          <?php foreach($good as $val): foreach($cate as $v): if($v['slsh_plateid'] == $val['slsh_category']): ?>
          <li class="pro_list" pid="14137" ppid="17146" type="normal" pno="201411254">
            <div class="s-img">
                <a href="__SITE__/index/good/goodinfo/goodid/<?php echo $val['slsh_goodid']; ?>" target="_blank">
                    <img class="lazy"  alt=""
                    src="__SITE__<?php echo $val['slsh_picture']; ?>">
                </a>
            </div>
            <div class="s-info">
                <div class="s-name">
                    <?php echo $val['slsh_goodname']; ?>
                </div>
                <div class="s-unit">
                    ￥<?php echo $val['slsh_goodprice']; ?>/<?php echo $val['slsh_spec']; ?>
                </div>
                <div class="s-che"></div>
            </div>
        </li>
...
<div class="fruit-kinds ">
    <div class="til clearfix">
        ...
        <div class="textPic"><img class="lazy" data-original="__STATIC__/Reception/Picture/szss.png" src="__STATIC__/Reception/Picture/szss.png"></div>
    </div>
    <div class="good-list clearfix">
        <ul class="clearfix">
           <?php foreach($good3 as $val): foreach($cate3 as $v): if($v['slsh_plateid'] == $val['slsh_category']): ?>
           <li class="pro_list" pid="14312" ppid="17338" type="normal" pno="2160929101">
            <div class="s-img">
                <a href="__SITE__/index/good/nutinfo/itemid/<?php echo $val['slsh_goodid']; ?>" target="_blank">
                    <img class="lazy"  alt=""
                    src="__SITE__<?php echo $val['slsh_picture']; ?>">
                </a>
            </div>
            ...
            <div class="pro_list_pos">
                <span class="pro_list_span" style="background: #65A032">新品</span>
            </div>
        </li>
        <?php endif; endforeach; endforeach; ?>
    </ul>
...
<div class="ad">
    <a target="_blank" href="/prodetail/index/7154"><img class="lazy" data-original="http://imgws4.fruitday.com/images/2016-11-17/e75f8f66e8a2649a74708deaedc41d3b.jpg" src="__STATIC__/Reception/Picture/guan_emptyad@2x.png"></a>
</div>
...
<div class="fruit-kinds ">
    <div class="til clearfix">
        <a href="/prolist/index/43" target="_blank" class="more">更多 &gt;</a>
        <ul class="pull-right">
        </ul>
        <div class="textPic"><img class="lazy" data-original="http://img9.fruitday.com/guan_t4.png" src="Picture/guan_default.png"></div>
    </div>
    <div class="good-list clearfix">
        <ul class="clearfix">
           <?php foreach($good2 as $val): foreach($cate2 as $v): if($v['slsh_plateid'] == $val['slsh_category']): ?>
           <li class="pro_list" pid="2068" ppid="5116" type="normal" pno="201411866">
            <div class="s-img">
                <a href="__SITE__/index/good/goodinfo/goodid/<?php echo $val['slsh_goodid']; ?>" target="_blank">
                    <img class="lazy"  alt=""
                    src="__SITE__<?php echo $val['slsh_picture']; ?>">
            ...
            <div class="s-info">
                ...
                <div class="s-unit">
                    ￥<?php echo $val['slsh_goodprice']; ?>/礼篮
                </div>
                <div class="s-che"></div>
            </div>
        </li>
...
<div class="shop-cart">
    <div class="shop-top">
        <div class="cha pull-right">
            <img src="__STATIC__/Reception/Picture/cha.png" alt=""></div>
        </div>
