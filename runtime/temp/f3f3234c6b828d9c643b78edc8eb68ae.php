<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wamp64\www\slsh\public/../application/admin\view\order\notsend.html";i:1481702513;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <?php foreach($orderinfo as $info): ?>
        <tr>
          <td style="text-align:left; padding-left:20px;"><?php echo $info['slsh_order']; ?></td>
          <td><?php echo $info['slsh_tel']; ?></td>
          <td width="10%"><img src="<?php echo $info['slsh_pic']; ?>" alt="" width="70" height="50" /></td>
          <td><?php echo $info['slsh_good']; ?></td>
          <td><font color="#00CC99"></font></td>
          <td><?php echo $info['slsh_price']; ?></td>
          <td><?php echo $info['slsh_creat_time']; ?></td>
          <td style="color:red;">未发送</td>
          <td ><a style="color:green;" href="__SITE__/admin/order/sendgood/orderid/<?php echo $info['slsh_oid']; ?>">安排配送</a></td>
        </tr>
        <?php endforeach; ?>
      ...
      <tr>
        <td colspan="8"><div class="pagelist"> <?php echo $orderinfo->render(); ?> </div></td>
      </tr>
    </table>
  </div>
</form>
