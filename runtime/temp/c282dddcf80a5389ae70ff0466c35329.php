<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\wamp\www\slsh\public/../application/index\view\good\nutinfo.html";i:1481722059;}*/ ?>
<!DOCTYPE html>
...
<div class="content typepage clearfix">
        ...
        <div class="price-info">
            ...
            <div class="buy clearfix">
                ...
                <div class="fr-buy pull-left">
                     <a href="__SITE__/index/good/order1/oider/<?php echo $info['slsh_goodid']; ?>" class="btn btn-primary btn-lg active " role="button" title="点击此按钮，到下一步确认购买信息">立即购买</a>
                </div>
    ...
    <div class="shop-cart">
        <div class="shop-top">
            ...
            <div style="margin-left:70px;margin-top:20px; font-size:25px;" id ="cg">是哦后</div>
