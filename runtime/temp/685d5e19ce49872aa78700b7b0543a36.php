<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\wamp64\www\slsh\public/../application/admin\view\info\buyer.html";i:1481698613;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
      ...
      <?php else: foreach($buyers as $key => $val): ?>     
        <tr>
         ...
         <td><?php echo $val['slsh_level']; ?></td>
          ...
          <td><a href="__SITE__/admin/user/account">账户</a></td>
