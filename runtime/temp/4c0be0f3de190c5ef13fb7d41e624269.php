<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\wamp64\www\slsh\public/../application/index\view\user\login.html";i:1481508578;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <link href="__STATIC__/Reception/Css/login.css" rel="stylesheet" type="text/css">
    ...
    <div class="login-sec clearfix">
      ...
      <div class="login-right pull-right">
        <div class="login-form">
            <form action="__SITE__/index/user/dologin" method="post">
            <ul>
              ...
              <li class="clearfix log-pass">
                ...
                <div class="password pull-left">
                  <input type="password" placeholder="请输入6-20位号码字符" class="form-control" id="pwd" name="password">
                  <span id="pwd1"></span>
                </div>
              </li>
              ...
              <li class="clearfix log-wj">
                    <div class="wj-mima clearfix pull-right">
                      ...
                      <div class="fr-wj pull-right"> <a href="/verify" target="_blank">忘记密码?</a> <a href="/quickLogin">快捷登录</a></div>
                    </div>
              </li>
              ...
              <li class="clearfix">
                    <div class="fruit-login pull-right">
                        <div class="fr-regist pull-left">
                           <a href="javascript:void(0);" class="btn-lg" role="button" id="submit">登录</a>
                           
                        </div>
                        <div class="fr-login pull-left">
                            <a href="__SITE__/index/user/register" class="btn-lg" role="button"> 注册会员
                            </a>
                        </div>
                    </div>
              </li>
...
margin-top:350px;top:-150px;background:#ffffff;left:-150px;margin-left:700px;display:none;border:1px solid #eeeeee">
    <img src="__STATIC__/Reception/Picture/smile.jpg" alt="" id="regcg" style="margin-left:120px;margin-top:20px; width:60px;height:60px">
         ...
         <span style="float:left;margin-top:80px;font-size:15px ;"><a href="" id="reg">商城首页</a></span>
</div>
</html>
</html>
<script>
