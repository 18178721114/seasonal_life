<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\wamp64\www\slsh\public/../application/index\view\good\pay.html";i:1481715677;}*/ ?>
...
<head>
    ...
    <title>天天果园-水果网购首选品牌，只为一份极致的新鲜！</title>
    <link href="__STATIC__/Reception/Css/order-online.css" rel="stylesheet" type="text/css">
    ...
    <!--<script src="http://www.fruitday.com/js/lib/prefixfree.min.js"></script>-->
    <script type="text/javascript" src="__STATIC__/Reception/Scripts/jquery-1.11.0.min.js"></script>
    <!--<script type="text/javascript" src="http://www.fruitday.com/js/lib/jquery.lazyload.min.js"></script>-->
    <!--<script type="text/javascript" src="http://www.fruitday.com/js/lib/bootstrap.min.js"></script>-->
...
<script type='text/javascript'>
    ...
    (function(w,d,s,l,a){
        ...
        })(window,document,'script','py','Um..uTxTXsbT929w925qCwQHQ0');

        py('set','user',{'category':'0'});
        py('event','viewPage');
    </script>

    <!-- BT -->
    <script type='text/javascript'>
        (function(win, doc, tag, src, name, account, script, pos) {
            win["__BDX_DCO_FUNC__"] = name;
            win[name] = win[name] || function() {
                (win[name].queue = win[name].queue || []).push(arguments);
            };
            win[name].start = +new Date();
            win[name].account = account;
            script = doc.createElement(tag);
            pos = doc.getElementsByTagName(tag)[0];
            script.async = 1;
            script.src = src;
            pos.parentNode.insertBefore(script, pos);
        })(window, document, 'script', (location.protocol == 'https:' ? 'https://cdn.masky.biddingx.com': 'http://cdn.scdng.com') + '/dco/js/t.min.js?v=1', 'BDX_DCO', 36420);
    </script>
    <script type='text/javascript'>
        window._CWiQ = window._CWiQ || [];
        window.BX_CLIENT_ID = 50791; // 帐号ID
        (function() {
            var c = document.createElement('script')
            ,p = 'https:'==document.location.protocol;
            c.type = 'text/javascript';
            c.async = true;
            c.src = (p?'https://':'http://')+'tp.ana.betterdsp.com/boot/0';
            var h = document.getElementsByTagName('script')[0];
            h.parentNode.insertBefore(c, h);
        })();
        _CWiQ.push(['_trackPdmp', '全站访客', 1]);
    </script>
</head>
<body>
    <!-- top -->
    ...
    <div class="pay_content">
        <div class="succeed clearfix">
            ...
            <div class="order_info clearfix pull-left">
                <div class="img pull-left">
                    <img src="__STATIC__/Reception/Picture/111.png" alt=""></div>
                    <div class="payorders pull-left">
                        ...
                        <div class="succeed-details clearfix">
                            ...
                            <p class="figure"><?php echo $order; ?></p>
                            <div class="cl"></div>
                        </div>
                    </div>
                </div>
                
                <form action="__SITE__/index/good/goodpay" method="post">
                    ...
                    <div class="pay_info pull-right">
                        <p class="value">
                            ...
                            <strong id="really_pay">
                                ￥<?php echo $zong; ?>
                                <input type="hidden" name="zong" value="<?php echo $zong; ?>">
                            </strong>元
                        </p>
            ...
            <div class="pay-options">
                <div id="online-pay-title" class="pay_ways clearfix">
                    <span class="pull-left choose" ></span>
                    <span class="pull-right pay_remain" >还需支付：<strong id="need_online_pay"><?php echo $zong; ?></strong>元</span>
                </div>
                <div class="option-bd">
                    <div class="sure-pay"><input style="margin-left:860px;font-size: 20px;background-color: #669933;color:white;border-radius:10px;" id="pay" type="submit" value="确认支付"></div>
        ...
        <div class="succeed clearfix">
            ...
            <div class="order_info clearfix pull-left">
                <div class="img pull-left">
                    ...
                    <div class="payorders pull-left">
                        ...
                        <div class="succeed-details clearfix">
                            <p class="ordernum">您的订单号:</p>
                            <p class="figure"><?php echo $order['slsh_order']; ?></p>
                            <div class="cl"></div>
                        </div>
                    </div>
                </div>
                ...
                <form action="__SITE__/index/good/goodpay" method="post">
                    ...
                    <div class="pay_info pull-right">
                        <p class="value">
                            <span></span>订单金额:
                            <strong id="really_pay">
                                <?php echo $order['slsh_price']; ?>
                                <input type="hidden" name="zong" value="<?php echo $order['slsh_price']; ?>">
                                <input type="hidden" name="id" value="<?php echo $order['slsh_oid']; ?>">
            ...
            <div class="pay-options">
                <div id="online-pay-title" class="pay_ways clearfix">
                    <span class="pull-left choose" ></span>
                    <span class="pull-right pay_remain" >还需支付：<strong id="need_online_pay"><?php echo $order['slsh_price']; ?></strong>元</span>
                </div>
                <div class="option-bd">
                    <div class="sure-pay"><input style="margin-left:860px;font-size: 20px;background-color: #669933;color:white;border-radius:10px;" id="pay" type="submit" value="确认支付"></div>
...
<input type="hidden" id="money" name="money" value="78.00">
<input type="hidden" id="order_id" name="order_id" value="1319660898">
<input type="hidden" id="pay_type" value="1" />
<input type="hidden" id="order_name" name="order_name" value="161213093246">
...
<script>
    ...
    function pay_lay_wx(){
        openwin('/order/paywx/'+'161213093246');
    }
    $(function(){

        //重载参数
        $('#need_send_code').val('0');

        $("#balance_box").on('click',function(){
            ...
            if($(this).hasClass('selected')){
                ...
                $.post('/ajax/order/cancelBalance',data,function(result_data){
                    ...
                    if(resp['code']=='200'){
                        ...
                        $("#online-pay-title").children().removeClass('grey');
                        $("#need_online_pay").removeAttr("style");

                        $(".pay-box").removeClass("selected").addClass("unselected");
...
//                        $('#really_pay').html('￥'+resp['msg']['order_money']);
if(parseFloat(resp['msg']['order_money']) > (resp['msg']['user_money'])){
    $('#balance_deduction_money').html('￥'+resp['msg']['user_money']);
} else{
    $('#balance_deduction_money').html('￥'+resp['msg']['order_money']);
}
                ...
                $.post('/ajax/order/useBalance',data,function(result_data){
                    ...
                    if(resp['code']=='200'){
                        ...
                        if(parseFloat(user_money) >= parseFloat(money)){
                            $("#online-pay-title").children().addClass('grey');
                            $("#need_online_pay").attr("style","color:#999");
                            $("#pay-ment").children().removeClass("active");
                        }


                        $(".pay-box").removeClass("unselected").addClass("selected");
                        var need_pay = resp['msg']['need_online_pay'];
                        $('#need_online_pay').html('￥'+need_pay);
//                        $('#really_pay').html('￥'+resp['msg']['order_money']);
$('#need_send_code').val(resp['msg']['need_send_code']);
if(parseFloat(resp['msg']['order_money']) > parseFloat(resp['msg']['user_money'])){
    $('#balance_deduction_money').html('￥'+resp['msg']['user_money']);
} else{
    $('#balance_deduction_money').html('￥'+resp['msg']['order_money']);
}
...
$('#is_pay').val(1);
$('#is_balance').val(1);
$('#pay_parent_id').val(resp['msg']['selectPayments']['pay_parent_id']);
}else{
    gdialog_info('余额异常,请重新支付');
    location.reload();
}
        ...
        $('#pay').on('click',function() {
            ...
            var ds = {
                'curr_pay': pay_parent_id + '|' + pay_id,
                'order_name': '161213093246'
            };

            //checkPay
            var need_online_pay = $('#need_online_pay').html().replace("￥","");

            if((need_online_pay > 0 && pay_parent_id == 9) || is_pay == 0)
            {
                                ...
                                $('#submit').on('click', function(){
                                    ...
                                    else
                                    {
                                        if(yecode != '' && yecode != null)
                                        {
                                            var data = {
                                                'msg': $("#msg").val(),
                                                'verification_code':yecode,
                                                'ver_code_connect_id':yecode_id,
                                                'order_name':ds.order_name
                                            };
                                            $.ajax({
                                                type: 'POST',
                                                data: data,
                                                url: "/ajax/order/checkBalanceCode",
                                                success : function(data){
                                                    if(data.code == 200){
                                                        if (pay_parent_id == 7) {
                                                            pay_lay_wx();
                                                        ...
                                                        var use_balance = $('#balance_box').hasClass('selected');
                                                        var data = {
                                                            'pay_id': pay_parent_id == 3 ? pay_parent_id : pay_id,
                                                            'pay_parent_id': pay_parent_id == 3 ? pay_id : pay_parent_id,
                                                            'order_name': '161213093246',
                                                        ...
                                                        $.post('/ajax/order/checkPay',pdata,function(result_data){
                                                            resp = eval('('+result_data+')');
                                                            if(resp['code']!='200'){
                                                                gdialog_comf_redirect(resp.msg,'/');
                                                                return;
                                                            }
                                                        });
                                                        ...
                                                        $.ajax({
                                                            type: 'POST',
                                                            url: '/ajax/order/changeOnlinePay',
                                                            data: data,
                                                            async: false,
                                                            success: function (data) {
                                                                ...
                                                                if (data.code == 200) {
                                                                    $('#payMent').empty();
                                                                    $('#payMent').html(data.msg);
                                                                    if(pay_parent_id == 5){
                                                                        location.href = '/order/succ/' + order_name;
                                                                    }
                                                                    document.forms["frm1"].submit();
                                                                }
                                                                else {
                                                                    gdialog_info('支付异常,请重新下单');
                                                                }
                                                            },
                                                            dataType: 'json'
                                                        });
...
else
{
    ...
    $.post('/ajax/order/checkPay',pdata,function(result_data){
        ...
        $('#pay-ment li').on('click',function(){
            ...
            if($("#balance_box").hasClass('selected') && user_money >= money)
            {
                $('.m-payment-list li').children().children('span').hide();
                gdialog_info('请取消选择余额后，再选择其他支付方式');
                return;
            }
            else{
...
<script type='text/javascript'>
    py('event','order' ,{
        ...
        'money':'78.00',
        'items':[]
    }).track('Um.uJ.pNvagfSDKG44T2KoM9HHC_');
</script>
