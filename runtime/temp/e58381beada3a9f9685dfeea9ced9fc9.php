<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\wamp\www\slsh\public/../application/admin\view\info\buyer.html";i:1481795116;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<form method="post" action="">
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <?php else: foreach($buyers as $key => $val): ?>     
        <tr>
          <td>
         ...
         <td><?php echo $val['slsh_level']; ?></td>
          ...
          <td><a href="__SITE__/admin/order/order/usertel/<?php echo $val['slsh_tel']; ?>">订单</a></td>
          <td><a href="__SITE__/admin/user/shopcar/shop/<?php echo $val['slsh_tel']; ?>">购物车</a></td>
          <td><a href="__SITE__/admin/user/account/userid/<?php echo $val['slsh_userid']; ?>">账户</a></td>
