<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\wamp64\www\slsh\public/../application/index\view\good\shopcar.html";i:1481696640;}*/ ?>
﻿<!DOCTYPE html>
...
<head>
    ...
    <link href="__STATIC__/Reception/Css/cart.css" rel="stylesheet" type="text/css">
...
<div class="cart w-750">
    ...
    <div class="cartmain cartspage">
        ...
        <div class="cart-order clearfix" id="shopgood">

            <?php if($session != ''): foreach($addgoodname as $val): ?>
            <ul class="list-unstyled">

                <li id='c_normal_18052' type="normal" pid="14138" ppid="18052">
                    <div class="cartbox clearfix">
                        <div class="cartorder-select pull-left clearfix">
                            <p class="select selected"></p><input type="hidden" value="" />
                        </div>
                        <div class="cart-imgs pull-left">
                            <a href="/prodetail/index/14138" target="_blank">

                                <img  id ="src1" src="<?php echo $val['slsh_picture']; ?>" alt="">

                            </a>
                            
                        </div>
                        <div class="cart-name pull-left">
                            <p><a href="/prodetail/index/14138" target="_blank" id="shopgood"><?php echo $val['slsh_shopgood']; ?></a></p>

                        </div>
                        <div class="spec-num pull-left">
                            <p id="spec"><?php echo $val['slsh_spec']; ?></p></div>
                            <div class="price-singular pull-left">
                                <p id="price"><?php echo $val['slsh_pirce']; ?></p>
                            </div>
                            <div class="num_sel_lage cart-goods pull-left clearfix">

                             <!-- <span><?php echo $val['slsh_num']; ?></span> -->
                             <span class="inC num pull-left btn-minus">-</span>
                             <input class="pull-left num" type="tel" disabled="" name='qty' autocomplete='on' value="<?php echo $val['slsh_num']; ?>"  >
                        ...
                        <div class="delete pull-left">
                            <a class="m-cartlist-delete deleteCartpro" href="__SITE__/index/good/gooddel/good/<?php echo $val['slsh_sid']; ?>">删除</a>
                        </div>
                    </div>
                    <div class="cl"></div>
                </li>
            </ul>
            <?php endforeach; elseif($goodname !=''): ?>
            <ul class="list-unstyled">
                <li id='c_normal_17713' type="normal" pid="13959" ppid="17713">
                    <div class="cartbox clearfix">
                        <div class="cartorder-select pull-left clearfix">
                            <!--<p class="select selected"></p><input type="hidden" value="" />-->
                        </div>
                        <?php foreach($goodsrc as $v2): ?>
                        <div class="cart-imgs pull-left">
                            <!-- <?php foreach($goodid as $v1): ?> -->
                            <a href="javascript:;" target="_blank">
                                <!-- <?php endforeach; ?> -->
                                <img src="<?php echo $v2['goodsrc']; ?>" alt="">

                            </a>
                        </div>
                        <?php endforeach; foreach($goodname as $v3): ?>
                        <div class="cart-name pull-left">
                            <p><a href="javascript:;" target="_blank" id="goodname1"><?php echo $v3['goodname']; ?></a></p>
                        </div>
                        <?php endforeach; foreach($goodspec as $v4): ?>
                        <div class="spec-num pull-left">

                            <p><?php echo $v4['goodspec']; ?></p>                   
                        </div>
                        <?php endforeach; foreach($goodprice as $v5): ?>  
                        <div class="price-singular pull-left">
                            <p><?php echo $v5['goodprice']; ?></p>
                        </div>
                        <?php endforeach; foreach($goodnum as $v6): ?>
                        <div class="num_sel_lage cart-goods pull-left clearfix">
                         <!--   //<p><?php echo $v6['goodnum']; ?></p> -->
                         <span class="inC num pull-left btn-minus">-</span>
                         <input class="pull-left" type="tel" disabled="" name='qty' autocomplete='on' value="1"  >
                         <span class="deC num pull-left btn-plus">+</span>
                     </div>
                     <?php endforeach; foreach($goodprice as $v5): ?>  
                     <div class="sum pull-left">
                    ...
                    <?php endforeach; foreach($goodid as $v1): ?>
                    <div class="delete pull-left">
                        <a class="m-cartlist-delete deleteCartpro" href="">删除</a>
                    </div>
                    <?php endforeach; ?>
                </div>
                <div class="cl"></div>
        ...
        <div class="cart-empty">
            购物车中还没有商品，<a href="/prolist/index/40" class="VI-color2">继续逛逛</a>吧！
        </div>
        <?php endif; ?>

    </div>
</div>
<div style="height:35px;width:80px;background-color:#65a031;position:relative;left:920px; text-align:center;line-height:35px;" id="pay"><a href="__SITE__/index/good/order" style="color:#ffffff;" >去支付</a></div>

</div>
<div id="exchange-dialog" style="display: none">
    <div class="dialog-mask"></div>
    <div class="dialog" style="width:620px; margin-left:-310px;">
        <h5 class="dialog-til"><span class="pull-right iconfont">&#xe60e;</span>请选择需要换购的商品</h5>
        <div class="dialog-con changePur" style="height:330px">
            <div class="formitem clearfix" style="margin-bottom:0;height:270px;overflow:auto;position:relative; padding:10px 0;">
                <ul class="clearfix">
                </ul>
            </div>
            <button type="button" class="btn btn-success" id="exchange-submit" style="display:block;margin:10px auto 0">确 定</button>
        </div>
  ...
  <!--  <script>
             $(function(){
              ...
              $('#pay').click(function(){
                ...
                $.ajax({
                 type: "POST",
                 url: "http://www.slshengxian.cn/index/order/order",
                 data: {},
